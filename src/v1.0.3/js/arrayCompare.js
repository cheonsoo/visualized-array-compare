...
function ArrayCompare({ canvas = null, prev = [], current = [], options = {} }) {
  if (!canvas) {
...
ArrayCompare.prototype.initialize = function() {
  this.ctx = this.container.getContext('2d');

  this.initData();

  const opt = this.options;
  this.ctx.imageSmoothingEnabled = this.options.imageSmoothingEnabled;
...
ArrayCompare.prototype.redraw = function() {
  this.initialize();
  this.draw();
};

ArrayCompare.prototype.initData = function() {
...
ArrayCompare.prototype.convertDataType = function() {
...
ArrayCompare.prototype.setGroups = function() {
  const groups = [];
  let groupIdx = 1;
...
ArrayCompare.prototype.getModule = function(id) {
  return this.data.find(module => module.id === id);
};

ArrayCompare.prototype.drawModule = function(info) {
  if (info.flag === 'moved') {
...
ArrayCompare.prototype.drawLine = function(from, to) {
  const self = this;
...
ArrayCompare.prototype.drawPrevModules = function() {
  const opt = this.options;
...
ArrayCompare.prototype.drawCurrentModules = function() {
  const opt = this.options;
...
ArrayCompare.prototype.drawChangedInfoArrow = function() {
  const opt = this.options;
...
ArrayCompare.prototype.drawChangedGroupArrow = function() {
  const opt = this.options;
